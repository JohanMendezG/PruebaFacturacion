...
CREATE DATABASE PruebaFacturacion
GO

USE PruebaFacturacion

IF OBJECT_ID('ProductosByFactura') IS NOT NULL
	DROP TABLE ProductosByFactura
...
PrecioUnidad VARCHAR(10) NOT NULL,
...
CREATE TABLE ProductosByFactura(
...
INSERT INTO ProductosByFactura(FacturaId,ProductoId,CantVendido) VALUES ('A1',1,2),('A1',2,1),('A2',3,1),('A3',4,1),('A3',1,2),('A3',2,3),('A4',3,2),('A5',1,2),('A5',3,1)
GO